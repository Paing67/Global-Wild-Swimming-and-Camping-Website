...
<body>
   ...
   <div class="container-fluid ">
    ...
    <nav class="col-2 bg-dark">
          ...
          <li class="nav-item">
            <a href="booking.php" class="nav-link text-light"><i class="bi bi-card-list fs-5 pe-2"></i>
              Booking</a>
          </li>

          <li class="nav-item">
            <a href="../review/review.php" class="nav-link text-light"><i class="bi bi-card-list fs-5 pe-2"></i>
              Review</a>
          </li>
